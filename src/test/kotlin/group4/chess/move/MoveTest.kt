...
class MoveTest: AnnotationSpec() {
    ...
    fun `king moves correctly`() {
        ...
        board.setPieceToField(startLocation, king)
        val move = Move(board, startLocation, endlocationh1, king)
    ...
    fun `knight moves correctly`() {
        ...
        for (endLocation in endLocations) {
            ...
            val move = Move(board, startLocation, endLocation, knight)
            move.movePiece()
        ...
        board.setPieceToField(startLocation, knight)
        val move = Move(board, startLocation, endlocationh1, knight)
    ...
    fun `queen moves correctly`(){
        ...
        for (endLocation in endLocations) {
            board.setPieceToField(startLocation, queen)
            val move = Move(board, startLocation, endLocation, queen)
            move.movePiece()
        ...
        board.setPieceToField(startLocation, queen)
        val move = Move(board, startLocation, endlocationc3, queen)
    ...
    fun `bishop moves correctly`(){
        ...
        for (endLocation in endLocations) {
            ...
            val move = Move(board, startLocation, endLocation, bishop)
            move.movePiece()
        ...
        board.setPieceToField(startLocation, bishop)
        val move = Move(board, startLocation, endlocationc5, bishop)
    ...
    fun `rook moves correctly`(){
        ...
        for (endLocation in endLocations) {
            ...
            val move = Move(board, startLocation, endLocation, rook)
            move.movePiece()
        ...
        board.setPieceToField(startLocation, rook)
        val move = Move(board, startLocation, endlocationg2, rook)
